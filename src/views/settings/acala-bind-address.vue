...
import { bind_own_acala_address, get_user_info } from '@/api/user'
...
async function bindAddress() {
  const r = await bind_own_acala_address(addressForm.address)
  if (r.error !== 0) {
...
<template>
  <div>
    ...
    <div>
      ...
      <p>When you authorized your github account to Crypto Pay Lab, we will generate an Acala Account by default, you can withdraw the dot you eraned anytime.</p>
